		...
		while (ch != 5 ) {
			...
			case 1:
				...
				for(CustomerDetails i:l) {
					if(adharNo.equals(i.getAdharNo())) {
			...
			case 2:
				...
				boolean found=SearchAccount.searchAccount(ac_no, l);
				if(found==true) {
					for(CustomerDetails i:l) {
			...
			case 3:
				...
				System.out.println("-------------------------------------------------------------------------------");
				if(SearchAccount.searchAccount(acc_no, l) == true) {
					System.out.println("Enter amount ");
					double amount=sc.nextDouble();
					Deposite.deposite(amount,acc_no, l);
					count=0;
				}
				else {
			...
			case 4:
				...
				String acc_noo = sc.next();
				System.out.println("-------------------------------------------------------------------------------");
				if(SearchAccount.searchAccount(acc_noo, l)==true) {
					System.out.println("Enter Amount ");
					double amount=sc.nextDouble();
					Withdraw.withdraw(amount,acc_noo, l);
					count=0;
				}
				else {
					System.out.println(" Invalid user ");
